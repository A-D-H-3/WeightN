      ...
      <Container fluid>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Your Progress!</Card.Title>
                <p className="card-category">6 Week Snapshot</p>
              </Card.Header>
              <Card.Body>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Nutrition</Card.Title>
                <p className="card-category">Average Food Intake</p>
              </Card.Header>
              <Card.Body>
                <div
                ...
                <div className="legend">
                  <i className="fas fa-circle text-info"></i>
                  Carbs <i className="fas fa-circle text-danger"></i>
                  Proteins <i className="fas fa-circle text-warning"></i>
                  Fats
                </div>
                <hr></hr>
                <div className="stats">
